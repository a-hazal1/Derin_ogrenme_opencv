...
pts = deque(maxlen = buffer_size) #nesnenin merkez pointleri ddequeinin içinde max size ı yukarııda belirlediğimiz
...
#aynı anda iki mavi renki bulamadığı için kodu yenileyerek tekrar yazacağım